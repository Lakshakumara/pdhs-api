...
-- CreateTable
CREATE TABLE "inspected_spare_part" (
    "id" TEXT NOT NULL,
    ...
    CONSTRAINT "inspected_spare_part_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "equipment_spare_parts" ADD CONSTRAINT "equipment_spare_parts_equipmentId_fkey" FOREIGN KEY ("equipmentId") REFERENCES "equipment"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
