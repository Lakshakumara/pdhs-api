...
const ROLE_PERMISSIONS = {
  ...
  ADMIN_PDHS: [
    ...
    'REPAIR_REQUEST_VIEW','REPAIR_REQUEST_CREATE','REPAIR_REQUEST_UPDATE',
    'USER_VIEW','AUDIT_VIEW'
  ],
  VIEWER_PDHS: [
    'INSTITUTE_VIEW','INVENTORY_VIEW','EQUIPMENT_VIEW',
    'REPAIR_REQUEST_VIEW','USER_VIEW','AUDIT_VIEW'
  ],
  SUPER_ADMIN_RDHS: [
    'INSTITUTE_VIEW','INSTITUTE_CREATE','INSTITUTE_UPDATE','INSTITUTE_DELETE',
    'INVENTORY_VIEW','INVENTORY_UPDATE',
    'EQUIPMENT_VIEW',
    'REPAIR_REQUEST_CREATE','REPAIR_REQUEST_UPDATE','REPAIR_REQUEST_VIEW',
    'USER_VIEW'
  ],
  ADMIN_RDHS: [
  ...
  VIEWER_RDHS: [
    'INSTITUTE_VIEW','INVENTORY_VIEW','EQUIPMENT_VIEW','REPAIR_REQUEST_VIEW'
  ],
  ...
  ADMIN_INSTITUTE: [
    'INSTITUTE_VIEW','INSTITUTE_CREATE','INSTITUTE_UPDATE',
    'INVENTORY_VIEW','INVENTORY_UPDATE','EQUIPMENT_VIEW',
    'REPAIR_REQUEST_CREATE','REPAIR_REQUEST_UPDATE','REPAIR_REQUEST_VIEW'
  ],
  VIEWER_INSTITUTE: [
    'INSTITUTE_VIEW','INVENTORY_VIEW','EQUIPMENT_VIEW','REPAIR_REQUEST_VIEW'
  ...
  STORE_KEEPER: [
    'INSTITUTE_VIEW','INVENTORY_VIEW','EQUIPMENT_VIEW','INVENTORY_UPDATE'
  ],
  BIOMEDICAL_TECHNICIAN: [
    'INSTITUTE_VIEW','INVENTORY_VIEW','EQUIPMENT_VIEW',
    'WORK_ORDER_ASSIGN','WORK_ORDER_COMPLETE','WORK_ORDER_VIEW',
    'REPAIR_REQUEST_UPDATE','REPAIR_REQUEST_VIEW'
  ],
  PROCUREMENT_OFFICER: [
    'INSTITUTE_VIEW','PROCUREMENT_VIEW','PROCUREMENT_CREATE',
    'INVENTORY_VIEW','EQUIPMENT_VIEW'
  ],
  INSTITUTION_USER: [
    'INSTITUTE_VIEW','INVENTORY_VIEW','EQUIPMENT_VIEW',
    'REPAIR_REQUEST_CREATE','REPAIR_REQUEST_UPDATE','REPAIR_REQUEST_VIEW'
...
module.exports = {
  ...
  userPermissions: [
    ...
    ...seedPermissions('usr_tech1', 'BIOMEDICAL_TECHNICIAN', 'usr_admin'),

    // usr_proc1 → PROCUREMENT_OFFICER
    ...seedPermissions('usr_proc1', 'PROCUREMENT_OFFICER', 'usr_admin'),

    // usr_store1 → STORE_KEEPER
    ...seedPermissions('usr_store1', 'STORE_KEEPER', 'usr_admin'),
    ...
    ...seedPermissions('usr_bh_rat', 'INSTITUTION_USER', 'usr_rdhs_rat'),

    // usr_dh_bal → INSTITUTION_USER
    ...seedPermissions('usr_dh_bal', 'INSTITUTION_USER', 'usr_rdhs_rat'),
